...
@section('content')
    <div class="container">
      ...
      <form class="form-signin" role="form" action="doRegister" method="post">
        ...
        <p><input type="password" name="passwd" value="" class="form-control" placeholder="密码" ></p>
        <p><input type="password" name="repasswd" value="" class="form-control" placeholder="重复密码" ></p>

      	...
      	<div class="row">
			  ...
			  <div class="form-group">
			    ...
			    <div class="col-sm-10">
			      ...
			      <input type="text" class="form-control" name="answers_txt[]" value="{{$a[$i]['txt'] or ''}}" style="display:none;" />
			      ...
			      @endif
			      <!--
			      <input type="file" title="上传图片({{$flag[$i]}}P)"  name="answers_img[]"  style="display:none;" />
			      -->
			  ...
			  <div class="form-group">
			    <label class="col-sm-2 control-label">看图时间</label>
			    <div class="col-sm-10">
			      <input type="text" class="form-control" name="read_time" value="{{$q['read_time'] or '0'}}" />
			    </div>
			  </div>

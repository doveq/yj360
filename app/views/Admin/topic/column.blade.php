...
<div class="row">
  ...
  <div class="row text-right">
    {{ Form::open(array('role' => 'form', 'class' => 'form-inline', 'method' => 'get')) }}
      <input type="hidden" id="column-id" name="id" value="{{$query['id']}}">
      ...
      <table class="table table-hover">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
                <a href="javascript:;" class="btn btn-primary btn-xs btn-add" data-id="{{$info['id']}}">添加到科目</a>
            </td>
          </tr>
          @endforeach
        </tbody>

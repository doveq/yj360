      	...
      	<div class="row">
			  ...
			  <div class="form-group" style="display:none;">
			    ...
			    <div class="col-sm-10">
			      ...
			      <input type="text" class="form-control" name="answers_txt[]" value="{{$txt}}" />
			      ...
			      <?php
					...
					if(isset($a[$i]['is_right']) && $a[$i]['is_right'])
						$answersBox .= "<input class='abox' type='checkbox' name='answers_right[]' checked='checked' value='$v' /> $txt";
					else
					   	$answersBox .= "<input class='abox' type='checkbox' name='answers_right[]' value='$v' /> $txt";
